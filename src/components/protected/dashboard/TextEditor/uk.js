export default {
	...
	"components.controls.image.dropFileText":
		"Перемістіть файли в цю область або натисніть для завантаження",

	// Inline
	"components.controls.inline.bold": "Жирний",
	"components.controls.inline.italic": "Курсів",
	...
	"components.controls.list.unordered": "Неупорядкований",
	...
	"components.controls.textalign.right": "Дело",
